...
{	const int maxScale = 2;
	...
	FileStorage fs("/home/mizobuchi/ros_workspace/src/phaseshift/calibration/intrinsics.yml", FileStorage::WRITE);
	if (fs.isOpened())
	{
	...
	fs.open("/home/mizobuchi/ros_workspace/src/phaseshift/calibration/extrinsics.yml", FileStorage::WRITE);
	if (fs.isOpened())
	{
...
void commandCallback(const std_msgs::Bool::ConstPtr& msg)
{
	...
	const char* outputProjFileName = "/home/mizobuchi/ros_workspace/src/phaseshift/calibration/proj_data.yml";
	const char* outputRtFileName   = "/home/mizobuchi/ros_workspace/src/phaseshift/calibration/rt_data.yml";
	...
	vector<string> imageList = getStringList("/home/mizobuchi/ros_workspace/src/phaseshift/color_image_list/raw_image_list.txt"/*parser.get<string>("imglist")*/);
	vector<string> xList = getStringList("/home/mizobuchi/ros_workspace/src/phaseshift/color_image_list/x_decode_list.txt"/*parser.get<string>("xlist")*/);
	vector<string> yList = getStringList("/home/mizobuchi/ros_workspace/src/phaseshift/color_image_list/y_decode_list.txt"/*parser.get<string>("ylist")*/);
	...
	const string calib_mode = "procam"; //parser.get<string>("calib_mode");
	if (calib_mode == "proj") {
...
int main(int argc, char* argv[])
{
	...
	ros::NodeHandle n;
	ros::Subscriber sub = n.subscribe("c_command",1,commandCallback);
